...
namespace Calopteryx.Modules.Identity.Core.DAL.Migrations
{
    ...
    [Migration("20230316023559_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Calopteryx.BuildingBlocks.Infrastructures.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Calopteryx.BuildingBlocks.Infrastructures.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    b.HasOne("Calopteryx.BuildingBlocks.Infrastructures.Identity.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
